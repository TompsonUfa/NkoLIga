            ...
            <div class="auth__form">
                ...
                <form method="post">
                    <div class="input-wrap">
                        <input v-model="this.form.email" type="email" name="email" id="email" class="auth__input" autocomplete="off"
                    ...
                    <div @click="this.submitForm()" class="btn auth__btn" :class="this.errors ? '' : 'mt-4'">Войти</div>
                </form>
            </div>
        </div>
    </main>
